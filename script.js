...
var seconds = 0;
var score = setInterval(timer, 1000);
function timer() {
	++seconds;
	var hour = Math.floor(seconds / 3600);
	var minute = Math.floor((seconds - hour * 3600) / 60);
	var secs = seconds - (hour * 3600 + minute * 60);
}
...
InfiniteRunner.draw = function(){
  ...
  this.fillText('HI SCORE: '+hiScore, this.width - (170 + (this.aceleration * 4)), 33 - (this.aceleration * 4));
  this.fillStyle = this.scoreColor;
  this.font = (12 + (this.aceleration * 3))+'pt Arial';
  this.fillText('SCORE: '+seconds, this.width - (150 + (this.aceleration * 4)), 50);
};